import { IconLeaf, IconSparkles, IconSeedling, IconMoon, IconWind } from '@tabler/icons-react'
...
const features = [
  {
    Icon: IconSeedling,
    title: 'Nourish',
    description: 'Functional nutrition tuned to your biology.',
  },
  {
    Icon: IconMoon,
    title: 'Calm',
    description: 'Mind-body practices to soften daily stress.',
  },
  {
    Icon: IconWind,
    title: 'Move',
    description: 'Movement that meets you where you are.',
  },
]
...
export default function LandingPage() {
  return (
    <main className="min-h-screen bg-bg flex flex-col">
      <header className="flex items-center justify-center gap-[7px] pt-8 pb-0">
