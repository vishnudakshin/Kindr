...
export const BIOMARKERS: Record<string, BiomarkerDef> = {
  ...
  'FAI': { unit: 'index', system: 'Hormones', direction: 'high_bad',
    ref: { high: 6.3 }, optimal: { high: 4.0 },
    note: 'Free Androgen Index = (Total Testosterone [ng/dL] × 3.467) / SHBG [nmol/L]. Values >6 in women suggest androgen excess (PCOS, adrenal hyperactivity).' },
