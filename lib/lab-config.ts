...
export const BIOMARKERS: Record<string, BiomarkerDef> = {
  ...
  'Neutrophils': { unit: '×10⁹/L', system: 'Blood & immune', direction: 'two_sided',
    ref: { low: 1.8, high: 7.5 }, critical: { low: 0.5 },
    note: 'Absolute neutrophil count. Values below 1.5 ×10⁹/L indicate neutropenia; <0.5 is severe and raises infection risk significantly.' },
  'Lymphocytes': { unit: '×10⁹/L', system: 'Blood & immune', direction: 'two_sided',
    ref: { low: 1.0, high: 4.5 },
    note: 'Absolute lymphocyte count. Low counts can indicate immune suppression; high counts are common in viral infections.' },
  'Monocytes': { unit: '×10⁹/L', system: 'Blood & immune', direction: 'two_sided',
    ref: { low: 0.2, high: 1.0 },
    note: 'Absolute monocyte count. Mildly elevated values often reflect chronic low-grade inflammation.' },
  ...
  'Ferritin': { unit: 'ng/mL', system: 'Blood & immune', direction: 'two_sided',
    ref: { male: { low: 12, high: 400 }, female: { low: 12, high: 200 } },
